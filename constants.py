...
######################## 
# DF_TITLE_NO, 
DF_VERDICT_NO, DF_INDICTMENT_NO, DF_LAWYER_NO, DF_DOC_ID_NO, DF_OWNER_NO, DF_CONTENT_NO, DF_DATE_POSTED_NO, DF_COURT_NO = range(8)
TEMBUSU_MODE = False
PROCESS_COUNT = 6 if TEMBUSU_MODE else 3
BATCH_SIZE = 6 if TEMBUSU_MODE else 6

CSV_FILE_TEST = "data\\newdatafull.csv"        # test indexing file with 100 documents
...
TITLE_WEIGHT = 1
CONTENT_WEIGHT = 1
ROCCHIO_ORIGINAL_QUERY_WEIGHT = 0.75
ROCCHIO_CENTROID_WEIGHT = 0.25
